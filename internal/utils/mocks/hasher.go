...
// CheckPassword provides a mock function with given fields: hash, password
func (_m *Hasher) CheckPassword(hash string, password string) bool {
...
func (_m *Hasher) GetPasswordHash(password string) (string, error) {
