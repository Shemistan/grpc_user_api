...
func ServiceUserToStorageUser(req serviceModel.User) storageModel.User {
...
func ServiceUpdateUserToStorageUpdateUser(req serviceModel.UpdateUser) storageModel.UpdateUser {
