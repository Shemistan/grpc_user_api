...
func (_m *TokenProvider) GenerateToken(info model.UserInfo, secretKey []byte, duration time.Duration) (string, error) {
...
func (_m *TokenProvider) VerifyToken(tokenStr string, secretKey []byte) (*model.UserClaims, error) {
