...
import (
	...
	model "github.com/Shemistan/grpc_user_api/internal/storage/user/model"
...
func (_m *User) Create(ctx context.Context, req model.User) (int64, error) {
...
func (_m *User) Update(ctx context.Context, req model.UpdateUser) error {
	ret := _m.Called(ctx, req)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, model.UpdateUser) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
